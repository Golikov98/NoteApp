...
AppId={{54BE0FF1-347D-48E0-96BA-57F398B7526E}
AppName={#MyAppName}
...
Source: "../NoteAppUI.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "../Значки\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
